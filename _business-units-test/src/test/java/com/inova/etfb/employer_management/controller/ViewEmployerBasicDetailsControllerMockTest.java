...
public class ViewEmployerBasicDetailsControllerMockTest extends BaseMockTest {
	...
	@Test
	public void getEmployerDetailsExceptionBlock() throws Exception {
		...
		when(viewEmployerDetailsService.search(any())).thenThrow(RuntimeException.class);
