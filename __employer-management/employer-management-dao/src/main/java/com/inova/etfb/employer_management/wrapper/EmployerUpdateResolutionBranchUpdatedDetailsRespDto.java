...
@SqlResultSetMapping(name = "EmployerUpdateResolutionBranchDetailsMapping", entities = {
        @EntityResult(entityClass = EmployerUpdateResolutionBranchUpdatedDetailsRespDto.class, fields = {
                ...
                @FieldResult(name = "nameUpdated", column = "name_updated"),
                @FieldResult(name = "statusUpdated", column = "status_updated"),
                @FieldResult(name = "addressUpdated", column = "address_updated"),
                @FieldResult(name = "headOfficeUpdated", column = "head_office_updated"),
                @FieldResult(name = "brnAddressUpdated", column = "brn_address_updated"),
                @FieldResult(name = "mailingAddressUpdated", column = "mailing_address_updated"),
                @FieldResult(name = "courtsNoteUpdated", column = "courts_note_updated"),
                @FieldResult(name = "branchUpdated", column = "branch_updated"),
                @FieldResult(name = "etfbBranchUpdated", column = "etfb_branch_updated"),
                @FieldResult(name = "etfbZoneUpdated", column = "etfb_zone_updated"),
                @FieldResult(name = "employerOwnEtfbBranchUpdated", column = "employer_own_etfb_branch_updated"),
                @FieldResult(name = "policeStationIdUpdated", column = "police_station_id_updated"),
                @FieldResult(name = "policeStationNoteUpdated", column = "police_station_note_updated"),
                @FieldResult(name = "localGovernmentAuthorityIdUpdated", column = "local_government_authority_id_updated"),
...
@NoArgsConstructor
@AllArgsConstructor
public class EmployerUpdateResolutionBranchUpdatedDetailsRespDto {
    @Id
