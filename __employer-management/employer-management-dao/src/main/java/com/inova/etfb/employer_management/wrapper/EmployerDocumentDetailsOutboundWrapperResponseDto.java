...
@SqlResultSetMapping(name = "EmployerDocumentDetailsOutboundResult" , entities = {
		@EntityResult(entityClass = EmployerDocumentDetailsOutboundWrapperResponseDto.class , fields = {
...
@Entity
public class EmployerDocumentDetailsOutboundWrapperResponseDto {
